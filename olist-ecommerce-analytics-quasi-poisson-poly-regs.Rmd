...
Customers <- read.csv("../input/brazilian-ecommerce/olist_customers_dataset.csv", header = TRUE)
Geolocation <- read.csv("../input/brazilian-ecommerce/olist_geolocation_dataset.csv", header = TRUE)
Items <- read.csv("../input/brazilian-ecommerce/olist_order_items_dataset.csv", header = TRUE)
Payments <- read.csv("../input/brazilian-ecommerce/olist_order_payments_dataset.csv", header = TRUE)
Reviews <- read.csv("../input/brazilian-ecommerce/olist_order_reviews_dataset.csv", header = TRUE)
Orders <- read.csv("../input/brazilian-ecommerce/olist_orders_dataset.csv", header = TRUE)
Products <- read.csv("../input/brazilian-ecommerce/olist_products_dataset.csv", header = TRUE)
Sellers <- read.csv("../input/brazilian-ecommerce/olist_sellers_dataset.csv", header = TRUE)
Pdttrans <- read.csv("../input/brazilian-ecommerce/product_category_name_translation.csv", header = TRUE)
